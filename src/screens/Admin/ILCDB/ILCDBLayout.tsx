...
const TABS = [
  { label: 'Highlights', path: '/kms/admin/ilcdb/highlights', icon: Image },
  { label: 'Charts', path: '/kms/admin/ilcdb/charts', icon: BarChart3 },
  { label: 'Datasets', path: '/kms/admin/ilcdb/datasets', icon: Database },
];

export default function ILCDBLayout() {
  ...
  return (
    <div className="p-8">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-black text-gray-900 dark:text-white">ILCDB</h1>
