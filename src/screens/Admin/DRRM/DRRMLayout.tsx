...
const TABS = [
  { label: 'Highlights', path: '/kms/admin/drrm/highlights', icon: Image },
  { label: 'Charts', path: '/kms/admin/drrm/charts', icon: BarChart3 },
  { label: 'Datasets', path: '/kms/admin/drrm/datasets', icon: Database },
];

export default function DRRMLayout() {
  ...
  return (
    <div className="p-8">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-black text-gray-900 dark:text-white">DRRM</h1>
